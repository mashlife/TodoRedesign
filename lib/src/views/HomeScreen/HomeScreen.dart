  ...
  Widget build(BuildContext context) {
    return Consumer<TodoProvider>(
      builder: (context, provider, child) {
        if (provider.data.isNotEmpty == false) {
          return Center(
            child: SizedBox(
              height: 80,
              width: 80,
              ...
              child: Column(
                children: [
                  ListView.separated(
                    ...
                    separatorBuilder: (context, index) => Utils.vertSpacer(10),
                    itemBuilder: (context, index) {
                      final todo = provider.data[index];
                      final isSelected = provider.selected.contains(todo);
                      ...
                      return Container(
                        ...
                        child: GestureDetector(
                          ...
                          onTap:
                              provider.selected.isEmpty
                                  ? () =>
                                      context.navigate(TodoScreen(todo: todo))
                                  : () {
                                    if (provider.selected.contains(todo)) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextType.subTitle(todo.description!),
                              Utils.vertSpacer(5),
